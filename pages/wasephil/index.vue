<template>
  <div id="top" class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-md-6 mb-4" @click="activityProgram">
      ...
      <div class="col-xl-3 col-md-6 mb-4" @click="profile">
...
export default {
    methods: {
      async activityProgram(){
        this.$router.push('/wasephil/activity_program')
      },
      async route(){
      ...
      async profile(){
        this.$router.push('/wasephil/profile')
      },
    },
    mounted: function(){
    },
