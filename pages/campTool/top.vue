<template>
    <div id="top">
        <div class="row">
            <div id="carfare" class="app col-xs-12 col-sm-4 text-center" @click="clickRoute">
            ...
            <div id="warehouse" class="app col-xs-12 col-sm-4 text-center" @click="clickRoute">
                <div class="title">倉庫・資材</div>
                <div class="icon">
